...
package bruteForce_10th;

import java.util.Scanner;

public class Q7568_Fixed {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);

        int N = sc.nextInt(); // 사람의 수
//        int kg[] = new int[N]; // 몸무게를 담을 배열
//        int cm[] = new int[N]; // 키를 담을 배열
//        int rank[] = new int[N]; // 순위를 담을 배열

//        int person[] = new int[N]; // 사람(몸무게 + 키)을 나타내는 2차 배열
        int person[][] = new int[N][2];
        // 사람(몸무게 + 키)을 나타내는 2차 배열
        // 몸무게, 키 -> [2]
...
//                cm[i] = sc.nextInt();
//                rank[i] = i+1;
            person[i][0] = sc.nextInt(); // i번째 사람의 몸무게
            person[i][1] = sc.nextInt(); // i번째 사람의 키
        }
